public class Main{
    ...
    public static void main(String[] args) {
        ...
        int voting[][] = new int[votersList.length][ballotForm];
        ...
        int[] pVotes = new int[5];
        int[] vpVotes = new int[5];
        int[] sVotes = new int[5];
        int[] tVotes = new int[5];


        for (int c1 = 0; c1 < voting.length; c1++) {
            if (voting[c1][1] == 1) pVotes[1]++;
            if (voting[c1][1] == 2) pVotes[2]++;
            if (voting[c1][1] == 3) pVotes[3]++;
            if (voting[c1][1] == 4) pVotes[4]++;

            if (voting[c1][2] == 1) vpVotes[1]++;
            if (voting[c1][2] == 2) vpVotes[2]++;
            if (voting[c1][2] == 3) vpVotes[3]++;
            if (voting[c1][2] == 4) vpVotes[4]++;

            if (voting[c1][3] == 1) sVotes[1]++;
            if (voting[c1][3] == 2) sVotes[2]++;
            if (voting[c1][3] == 3) sVotes[3]++;
            if (voting[c1][3] == 4) sVotes[4]++;

            if (voting[c1][4] == 1) tVotes[1]++;
            if (voting[c1][4] == 2) tVotes[2]++;
            if (voting[c1][4] == 3) tVotes[3]++;
            if (voting[c1][4] == 4) tVotes[4]++;
        }


        System.out.println("President");
        for (int e1 = 1; e1 < presidentList.length; e1++) { System.out.println(presidentList[e1] + " : " + pVotes[e1] + " votes"); }
        if (pVotes[1] > pVotes[2] && pVotes[1] > pVotes[3] && pVotes[1] > pVotes[4]) System.out.println(presidentList[1] + " won");
        if (pVotes[2] > pVotes[1] && pVotes[2] > pVotes[3] && pVotes[2] > pVotes[4]) System.out.println(presidentList[2] + " won");
        if (pVotes[3] > pVotes[1] && pVotes[3] > pVotes[2] && pVotes[3] > pVotes[4]) System.out.println(presidentList[3] + " won");
        if (pVotes[4] > pVotes[1] && pVotes[4] > pVotes[2] && pVotes[4] > pVotes[3]) System.out.println(presidentList[4] + " won");

        System.out.println("Vice President");
        for (int e2 = 1; e2 < vicepresidentList.length; e2++) { System.out.println(vicepresidentList[e2] + " : " + vpVotes[e2] + " votes"); }
        if (vpVotes[1] > vpVotes[2] && vpVotes[1] > vpVotes[3] && vpVotes[1] > vpVotes[4]) System.out.println(vicepresidentList[1] + " won");
        if (vpVotes[2] > vpVotes[1] && vpVotes[2] > vpVotes[3] && vpVotes[2] > vpVotes[4]) System.out.println(vicepresidentList[2] + " won");
        if (vpVotes[3] > vpVotes[1] && vpVotes[3] > vpVotes[2] && vpVotes[3] > vpVotes[4]) System.out.println(vicepresidentList[3] + " won");
        if (vpVotes[4] > vpVotes[1] && vpVotes[4] > vpVotes[2] && vpVotes[4] > vpVotes[3]) System.out.println(vicepresidentList[4] + " won");

        System.out.println("Secretary ");
        for (int e3 = 1; e3 < secretaryList.length; e3++) { System.out.println(secretaryList[e3] + " : " + sVotes[e3] + " votes"); }
        if (sVotes[1] > sVotes[2] && sVotes[1] > sVotes[3] && sVotes[1] > sVotes[4]) System.out.println(secretaryList[1] + " won");
        if (sVotes[2] > sVotes[1] && sVotes[2] > sVotes[3] && sVotes[2] > sVotes[4]) System.out.println(secretaryList[2] + " won");
        if (sVotes[3] > sVotes[1] && sVotes[3] > sVotes[2] && sVotes[3] > sVotes[4]) System.out.println(secretaryList[3] + " won");
        if (sVotes[4] > sVotes[1] && sVotes[4] > sVotes[2] && sVotes[4] > sVotes[3]) System.out.println(secretaryList[4] + " won");

        System.out.println("Treasurer ");
        for (int e4 = 1; e4 < treasurerList.length; e4++) { System.out.println(treasurerList[e4] + " : " + tVotes[e4] + " votes"); }
        if (tVotes[1] > tVotes[2] && tVotes[1] > tVotes[3] && tVotes[1] > tVotes[4]) System.out.println(treasurerList[1] + " won");
        if (tVotes[2] > tVotes[1] && tVotes[2] > tVotes[3] && tVotes[2] > tVotes[4]) System.out.println(treasurerList[2] + " won");
        if (tVotes[3] > tVotes[1] && tVotes[3] > tVotes[2] && tVotes[3] > tVotes[4]) System.out.println(treasurerList[3] + " won");
        if (tVotes[4] > tVotes[1] && tVotes[4] > tVotes[2] && tVotes[4] > tVotes[3]) System.out.println(treasurerList[4] + " won");
